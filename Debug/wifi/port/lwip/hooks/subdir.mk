...
C_SRCS += \
../wifi/port/lwip/hooks/lwip_default_hooks.c 

C_DEPS += \
./wifi/port/lwip/hooks/lwip_default_hooks.d 

OBJS += \
./wifi/port/lwip/hooks/lwip_default_hooks.o 


# Each subdirectory must supply rules for building sources it contributes
wifi/port/lwip/hooks/%.o: ../wifi/port/lwip/hooks/%.c wifi/port/lwip/hooks/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-wifi-2f-port-2f-lwip-2f-hooks

clean-wifi-2f-port-2f-lwip-2f-hooks:
	-$(RM) ./wifi/port/lwip/hooks/lwip_default_hooks.d ./wifi/port/lwip/hooks/lwip_default_hooks.o

.PHONY: clean-wifi-2f-port-2f-lwip-2f-hooks
